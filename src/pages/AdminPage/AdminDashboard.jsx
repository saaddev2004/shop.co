...
import { 
  ...
  FiSun, FiEye, FiUsers, FiDollarSign, FiChevronRight, FiCheck
} from "react-icons/fi";
...
const AdminDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FBFBFB] dark:bg-black text-black dark:text-white flex transition-colors duration-500 font-body">
            ...
            {/* SIDEBAR */}
            <aside className="w-72 bg-white dark:bg-neutral-900 border-r border-black/[0.05] dark:border-white/[0.05] flex flex-col justify-between sticky top-0 h-screen z-40">
                <div>
            ...
            <main className="flex-1 flex flex-col min-h-screen overflow-x-hidden">
                ...
                {/* TOP HEADER */}
                <header className="h-24 bg-white dark:bg-neutral-900 border-b border-black/[0.05] dark:border-white/[0.05] px-10 flex items-center justify-between sticky top-0 z-30">
                    <div className="flex items-center gap-4">
                        <h2 className="text-xl font-bold uppercase tracking-widest text-black/40 dark:text-white/40 font-heading">
                    ...
                    <div className="flex items-center gap-6">
                        <button 
                            onClick={toggleTheme}
                            className="w-12 h-12 rounded-xl bg-gray-50 dark:bg-neutral-800 flex items-center justify-center hover:scale-105 transition-all text-black/60 dark:text-white/60"
                        >
                            {isDarkMode ? <FiSun size={18} /> : <FiMoon size={18} />}
                        </button>

                        <div className="flex items-center gap-4 pl-6 border-l border-black/[0.05] dark:border-white/[0.05]">
                            ...
                            <div className="w-12 h-12 bg-black dark:bg-white rounded-xl flex items-center justify-center font-black text-white dark:text-black text-sm uppercase">
                ...
                <div className="flex-1 p-10 max-w-7xl w-full mx-auto">
                        ...
                        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {stats.cards.map((stat, idx) => (
                                    <div key={idx} className="dashboard-card p-7 rounded-3xl flex flex-col justify-between h-40">
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <p className="text-[10px] font-bold uppercase tracking-widest text-black/40 dark:text-white/40 mb-1">{stat.label}</p>
                                                <h3 className="text-2xl font-black tracking-tight dark:text-white">{stat.value}</h3>
                                            </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                <div className="lg:col-span-8 dashboard-card p-8 rounded-[35px] flex flex-col justify-between">
                                    ...
                                    {/* Dynamic SVG Chart */}
                                    <div className="h-64 relative flex items-end justify-between w-full pt-10 px-4 overflow-hidden rounded-2xl">
                                ...
                                <div className="lg:col-span-4 dashboard-card p-8 rounded-[35px] flex flex-col justify-between">
                                    <div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                {/* Recent Products */}
                                <div className="dashboard-card p-8 rounded-[35px]">
                                    <div className="flex justify-between items-center mb-6">
                                                ...
                                                <div key={order.id} className="flex items-center justify-between pt-4 first:pt-0">
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <span className={`inline-block text-[9px] font-bold px-2.5 py-0.5 rounded-full mt-1.5 ${
                                                            order.status === 'Delivered' ? 'bg-green-50 text-green-600 dark:bg-green-950/20 dark:text-green-400' :
                    ...
                    {activeTab === "products" && (
                        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-6 bg-white dark:bg-neutral-900 p-6 rounded-3xl border border-black/[0.04] dark:border-white/[0.04] shadow-sm">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <button 
                                        onClick={() => { resetForm(); setActiveTab("editor"); }}
                                        className="bg-black dark:bg-white text-white dark:text-black px-6 rounded-2xl font-bold text-xs flex items-center gap-2 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-black/5"
                                    >
                                        <FiPlus /> Add Product
                                    </button>
                                </div>
                            ...
                            <div className="bg-white dark:bg-neutral-900 rounded-[35px] border border-black/[0.04] dark:border-white/[0.04] shadow-sm overflow-hidden">
                        ...
                        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-black/40 dark:text-white/40 mt-1">Configure specification matrix and visual media parameters</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                                ...
                                <div className="lg:col-span-7 space-y-8">
                                    <div className="bg-white dark:bg-neutral-900 p-8 md:p-10 rounded-[35px] border border-black/[0.04] dark:border-white/[0.04] shadow-sm space-y-8">
                                ...
                                <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-32">
                                    <div className="bg-white dark:bg-neutral-900 p-8 md:p-10 rounded-[35px] border border-black/[0.04] dark:border-white/[0.04] shadow-sm space-y-6">
                                        <h4 className="text-sm font-bold uppercase tracking-wider dark:text-white flex items-center gap-3 border-b border-black/[0.03] dark:border-white/[0.03] pb-4">
                    ...
                    {activeTab === "orders" && (
                        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                            <div className="bg-white dark:bg-neutral-900 p-6 rounded-3xl border border-black/[0.04] dark:border-white/[0.04] shadow-sm">
                        ...
                        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white dark:bg-neutral-900 p-10 rounded-[35px] max-w-lg w-full border border-black/5 space-y-6">
                            ...
                            <div className="flex justify-between items-center pt-4 border-t border-black/[0.05] dark:border-white/[0.05]">
                                <div className="space-y-1">
                                    ...
                                    <span className={`badge block w-fit ${
